package com.otatime_server.auth.service;

import com.auth0.jwt.JWT;
import com.auth0.jwt.algorithms.Algorithm;
import com.auth0.jwt.exceptions.JWTVerificationException;
import com.otatime_server.auth.login.LoginService;
import com.otatime_server.event.refreshtoken.RefreshTokenEvent;
...
public class JwtService {
    ...
    public TokenResponse toTokenResponse(String email) {
        ...
        return new TokenResponse(accessToken, refreshToken, user.getUsername(), user.getProfileImageUrl());
    }
